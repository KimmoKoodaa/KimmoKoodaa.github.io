...
/*	// Sortataan data päivämäärän mukaan eli eka päivä ensimmäisenä
...
//	var j = 0;
	...
	//	alert("ap on: " + dataAP[j]);
		var data = dataAP[j];//[0].split(',');
		tulos[j] = new Array();
		tulos[j][0] = data[0][2];
		tulos[j][1] = data[0][12];
		tulos[j][2] = data[0][0];

	//	alert(data[0][2] + " - " +data[0][12] + " - " +data[0][0] + " - " );
